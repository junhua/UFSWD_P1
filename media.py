...
# including movie title, box art URL (or poster URL) and a YouTube link to
# the movie trailer.
...
def main():
    movies = [
        ...
        Movie("Bridge of Spies",
              "http://ia.media-imdb.com/images/\M/MV5BMjIxOTI0MjU5NV5BMl5BanBn"
              "XkFtZTgwNzM4OTk4NTE@._V1_SX214_AL_.jpg",
              "https://www.youtube.com/watch?v=mBBuzHrZBro"),

        # The Walk
        Movie("The Walk",
              "http://ia.media-imdb.com/images/M/MV5BMTU5MDgyNDgzM15BMl5BanBnX"
              "kFtZTgwNDA1MjI0NTE@._V1_SX214_AL_.jpg",
              "https://www.youtube.com/watch?v=GR1EmTKAWIw"),

        # Everest
        Movie("Everest",
              "http://ia.media-imdb.com/images/M/MV5BNTgyNzE3NjM0OV5BMl5BanBnXk"
              "FtZTgwNTM4Nzk4NTE@._V1_SX214_AL_.jpg",
